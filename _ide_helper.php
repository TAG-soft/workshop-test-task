 ...
 * Generated for Laravel 5.8.17 on 2019-05-21 10:48:56.
 *
...
namespace Illuminate\Html { 
    ...
    class FormFacade {
        ...
        {
                        /** @var \Illuminate\Html\FormBuilder $instance */
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Illuminate\Html\FormBuilder::mixin($mixin, $replace);
        }
    ...
    class HtmlFacade {
        ...
        {
                        /** @var \Illuminate\Html\HtmlBuilder $instance */
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Illuminate\Html\HtmlBuilder::mixin($mixin, $replace);
        }
